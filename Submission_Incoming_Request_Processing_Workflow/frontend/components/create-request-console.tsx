  ...
  return (
    <main className="notion-grid min-h-screen">
      <div className="flex min-h-screen bg-background/80">
        ...
        <section className="min-w-0 flex-1 px-3 py-3 sm:px-4">
          <div className="min-h-[calc(100vh-1.5rem)] border bg-[#fbfaf6]/92 shadow-[0_1px_1px_rgba(31,35,40,0.04),0_30px_90px_rgba(31,35,40,0.08)]">
